...
final class MoviesLoaderTests: XCTestCase {
    ...
    func testFailureLoading() throws {
        // Given
        let stubNetworkClient = StubNetworkClient(emulate: .error)
        let loader = MoviesLoader(networkClient: stubNetworkClient)
    ...
    func testLoadedSuccesfullyButGotErrorMessage() throws {
        // Given
        let stubNetworkClient = StubNetworkClient(emulate: .errorMessage)
        let loader = MoviesLoader(networkClient: stubNetworkClient)
    ...
    func testLoadedSuccesfullyButGotNoItems() throws {
        // Given
        let stubNetworkClient = StubNetworkClient(emulate: .noItems)
        let loader = MoviesLoader(networkClient: stubNetworkClient)
...
struct StubNetworkClient: NetworkRouting {
    ...
    let emulate: Emulation
    
    init(emulate: Emulation = .success) {
    ...
    func fetch(url: URL, handler: @escaping (Result<Data, Error>) -> Void) {
        ...
        case .noItems:
            handler(.success(expectedResponseWithNoItems))
        }
    }
    ...
    private var expectedResponseWithNoItems: Data {
        """
        {
           "errorMessage" : "",
           "items" : []
